...
namespace Gekomod\Controller\Admin;
...
class FilesAdminController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->render('@FilesAdmin/admin/index.html.twig');
    }

    /**
     * @Route(path="/filesfolders/{dir}")
     */
    public function filesfolders(Request $request, $dir)
    {
          if($dirs == '*') { $di= "./*"; }  else { 
            $d = str_replace(",","/",$dirs);
            $di = "".$d."/*"; }
    ...
    {
        $entity = $this->findOrNotFound(Flashdata::class, $id);
